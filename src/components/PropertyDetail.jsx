    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div className="flex items-center text-sm sm:text-base">
          <FaBed className="text-yellow-600 text-lg sm:text-xl mr-2" />
          <span>{property.rooms} bedrooms</span>
        </div>
        <div className="flex items-center text-sm sm:text-base">
          <FaMapMarkerAlt className="text-yellow-600 text-lg sm:text-xl mr-2" />
          <span>{property.location}</span>
        </div>
        <div className="flex items-center text-sm sm:text-base">
          <FaCalendarAlt className="text-yellow-600 text-lg sm:text-xl mr-2" />
          <span>{property.year_built}</span>
        </div>
        <div className="flex items-center text-sm sm:text-base">
          <FaRuler className="text-yellow-600 text-lg sm:text-xl mr-2" />
